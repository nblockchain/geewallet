    ...
    let serializedChannelJson = """
{
  ...
  "value": {
      ...
      "fields": [
        {
          "commitments": {
            "localParams": {
              "nodeId": "02323d281f323fc7513660602736a7bcd90d9d06057c9fa9e8d2deb0de5aeb2231",
              "channelPubKeys": {
              ...
              "maxHTLCValueInFlightMSat": 0.0000001,
              "channelReserveSatoshis": 2000,
              "htlcMinimumMSat": 0.00000001,
              "toSelfDelay": 6,
              "maxAcceptedHTLCs": 10,
              "isFunder": true,
            ...
            "remoteParams": {
              ...
              "maxHTLCValueInFlightMSat": 0.00198,
              "channelReserveSatoshis": 2000,
              "htlcMinimumMSat": 0.00000000001,
              "toSelfDelay": 144,
            ...
            "remoteCommit": {
              ...
              "txId": "2ce238b4fe973636e02004a6af2dd434a4221b1757ea62b0b0abac810674f3e8",
          ...
          "channelUpdate": {
            "signature@": "30440220769a6c21a0cacb27fca747b98f6637878164c21c35b6d33131469ba13fed290d02201552dfc5db9980996064a9d432ac28563c6c347b66ef4bd99ad3d0a3873efdf2",
            "contents@": {
    ...
    "remoteNodeId": "02323d281f323fc7513660602736a7bcd90d9d06057c9fa9e8d2deb0de5aeb2231",
    "minSafeDepth": 3
  }
}
"""
