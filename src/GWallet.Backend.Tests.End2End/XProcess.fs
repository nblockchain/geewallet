...
module XProcess =
    ...
    type XProcess =
        ...
        static member private CreateOutputReceiver processName processId (firstOutputTerminated: Ref<bool>) (output: ConcurrentQueue<string>) =
        ...
        static member Start processName processArgs processEnv =
            ...
            if Environment.OSVersion.Platform = PlatformID.Unix then
                ...
                let processPath =
                    match XProcess.TryDiscoverProcessPath processName envPath with
