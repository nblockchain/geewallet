...
module Account =
                    ...
                    yield
                        async {
                            if (account :> IAccount).Currency.IsEtherBased () then
                                try
                                    Ether.Account.CheckValidPassword
                                        account
                                        password

                                    return true
                                with
                                | :? InvalidPassword -> return false
                            else
                                try
                                    UtxoCoin.Account.CheckValidPassword
                                        account
                                        password
    ...
    let CreateReadOnlyAccounts
        (watchWalletInfo: WatchWalletInfo)
        : Async<unit> =
        async {
