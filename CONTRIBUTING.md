...
- Speed improvements:
  * Instead of defaulting to a consistency setting of 2u (servers), default to 1u in case there's a cache value that matches the result (so it's kinda a consistency of 1.5u).
