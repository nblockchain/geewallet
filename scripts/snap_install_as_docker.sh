...
RUN apt update &&\
 ...
 apt install -y snapd=2.44.3+20.04 snap-confine=2.44.3+20.04 &&\
 apt install -y fuse squashfuse sudo init lsb-release git docker.io build-essential pkg-config curl &&\
